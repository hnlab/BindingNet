...
for i in {1..5};
do
model_path=train_results/true_lig_alone_modify_dists/epoch_500_shuffle_true/diff_split/rm_core_ids/PLANet_Uw/complex_6A/$i/best_checkpoint.pth
model_name=PLANet_Uw_rm_CASF_ids_cmx
valid_set_hdf=dataset/true_lig_alone/diff_split/rm_core_ids/PLANet_Uw/complex_6A/${i}${i}${i}/PLANet_valid_true_rec.hdf
train_set_hdf=dataset/true_lig_alone/diff_split/rm_core_ids/PLANet_Uw/complex_6A/${i}${i}${i}/PLANet_train_true_rec.hdf
test_set_hdf=dataset/true_lig_alone/diff_split/rm_core_ids/PLANet_Uw/complex_6A/${i}${i}${i}/PLANet_test_true_rec.hdf
