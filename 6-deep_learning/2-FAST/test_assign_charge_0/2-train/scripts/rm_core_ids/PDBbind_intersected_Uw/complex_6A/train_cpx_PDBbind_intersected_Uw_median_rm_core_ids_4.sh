#!/bin/bash
#$ -S /bin/bash
#$ -N IUwRI_4ChC_shuff_epoch_500_train
#$ -q cuda
#$ -o /pubhome/xli02/project/PLIM/deep_learning/FAST/fast_plim/test_asign_charge/2-train/scripts/rm_core_ids/PDBbind_intersected_Uw/complex_6A/log/PDBbind_intersected_Uw_median_Rm_core_ids_complex_asign_charge_0_4.log
#$ -j y
#$ -r y
#$ -pe cuda 4
#$ -notify
...
python test_asign_charge/2-train/train_reduce_valid.py \
    ...
    --checkpoint-dir test_asign_charge/train_res/rm_core_ids/PDBbind_intersected_Uw/complex_6A/4/ \
