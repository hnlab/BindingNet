#!/bin/bash
#$ -S /bin/bash
#$ -N chaC1_UwRcid_shuff_train
#$ -q ampere
#$ -o /pubhome/xli02/project/PLIM/deep_learning/FAST/fast_plim/test_asign_charge/2-train/scripts/rm_core_ids/PLANet_Uw/complex_6A/log/Uw_median_Rm_core_ids_cmx_asign_chrage_0_1.log
#$ -j y
#$ -r y
#$ -R y
#$ -pe ampere 20
...
python test_asign_charge/2-train/train_reduce_valid.py \
    ...
    --checkpoint-dir test_asign_charge/train_res/rm_core_ids/PLANet_Uw/complex_6A/1/ \
    --dataset-name PLIM \
    --rec true_rec \
    --shuffle \
    --epochs 500
