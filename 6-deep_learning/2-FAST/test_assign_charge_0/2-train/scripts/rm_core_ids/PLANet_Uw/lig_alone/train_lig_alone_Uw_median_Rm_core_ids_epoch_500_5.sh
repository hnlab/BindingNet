#!/bin/bash
#$ -S /bin/bash
#$ -N chaL5_UwRcid_shuff_train
#$ -q cuda
#$ -o /pubhome/xli02/project/PLIM/deep_learning/FAST/fast_plim/test_asign_charge/2-train/scripts/rm_core_ids/PLANet_Uw/lig_alone/log/Uw_median_Rm_core_ids_lig_alone_asign_chrage_0_5.log
#$ -j y
#$ -r y
#$ -l gpu=1
#$ -notify
...
python test_asign_charge/2-train/train_reduce_valid.py \
    ...
    --checkpoint-dir test_asign_charge/train_res/rm_core_ids/PLANet_Uw/lig_alone/5/ \
    --dataset-name PLIM \
    --shuffle \
    --epochs 500
    # --rec true_rec \
