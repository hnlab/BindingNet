...
#$ -N Pm_pred
#$ -q cuda
#$ -o /pubhome/xli02/project/PLIM/deep_learning/RFscore/2-search_parameter/pred_scripts/rm_core_ids/PDBbind_minimized/log/PDBbind_minimized_Rm_core_ids.log
#$ -j y
#$ -r y
#$ -l gpu=1
#$ -notify
