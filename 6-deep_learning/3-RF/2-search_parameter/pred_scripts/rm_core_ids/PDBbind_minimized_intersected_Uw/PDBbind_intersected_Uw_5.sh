...
#$ -N PmIUw5_pred
#$ -q cuda
#$ -o /pubhome/xli02/project/PLIM/deep_learning/RFscore/2-search_parameter/pred_scripts/rm_core_ids/PDBbind_intersected_Uw/log/PDBbind_minimized_intersected_Uw_Rm_core_ids_5.log
#$ -j y
#$ -r y
#$ -l gpu=1
#$ -notify
