#!/bin/bash
#$ -S /bin/bash
#$ -N PmIUw_search_para_2
#$ -q cuda
#$ -o /pubhome/xli02/project/PLIM/deep_learning/RFscore/2-search_parameter/scripts/rm_core_ids/log/PDBbind_minimized_intersected_Uw_Rm_core_ids.log
#$ -j y
#$ -r y
#$ -R y
#$ -pe cuda 4
